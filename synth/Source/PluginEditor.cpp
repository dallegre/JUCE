...
void SynthAudioProcessorEditor::sliderValueChanged(Slider* slider){
    ...
    processor.detValScaled =   (processor.detVal - 0.5f) * 2.0f;
}
...
void SynthAudioProcessorEditor::paint (Graphics& g)
{
    ...
    g.drawFittedText("Freq", 60,  20, getWidth(), 30, Justification::bottom, 1);
    g.drawFittedText("Res",  90,  20, getWidth(), 30, Justification::bottom, 1);
    g.drawFittedText("Env",  120, 20, getWidth(), 30, Justification::bottom, 1);
    g.drawFittedText("Rate", 150, 20, getWidth(), 30, Justification::bottom, 1);
} 
...
void SynthAudioProcessorEditor::resized()
{
    ...
    freqSlider.setBounds( 60,  50, 20, getHeight() - 90);
    qSlider.setBounds(    90,  50, 20, getHeight() - 90);
    envSlider.setBounds(  120, 50, 20, getHeight() - 90);
    speedSlider.setBounds(150, 50, 20, getHeight() - 90);
}
